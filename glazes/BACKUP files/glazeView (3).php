...
<div id='content-container' >
	<!-- Header (Glaze Name)-->
        ...
        <div id="glazeTitle">Glaze name</div>
            <div id="headerBtns">
                <button onclick="window.location='/glazes/DYLMG_postGlaze.php?glazeID=new'" class="ui-button ui-widget ui-state-default ui-button-text-only" role="button"><span class="ui-icon ui-icon-plusthick" style="float:left"></span>&nbsp; New Glaze</button>
                <button class="input_newVar ui-button ui-widget ui-state-default ui-button-text-only" role="button"><span class="ui-icon ui-icon-plusthick" style="float:left"></span>&nbsp; New Variation</button>
                <div class="clear"></div>
