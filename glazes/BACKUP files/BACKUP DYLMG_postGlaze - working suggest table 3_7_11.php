...
var normalCSS = {'background-color':'#EFEFEF',
				'font-weight':'normal',
				'color':'#880000',
				'cursor':'auto'}; 

var hoverCSS = {'background-color':'#FFFF99',
				'font-weight':'bold',
				'color':'black',
...
$(document).ready(function() {
	...
	$('#input_ingrFilter').keyup(function(evt) {
		...
		$('.ingrRow').css(normalCSS);
		targetRow.css(hoverCSS);	
		evt.preventDefault();
		return false;
	});
...
<div id="srch_loading"></div><br>

<h3>Ingredient List</h3>
<div style="float:left; width:200px">
<select name='ingrID' size=15 id='select_ingrID' style='width:175px; height:400px;'>
</select>
