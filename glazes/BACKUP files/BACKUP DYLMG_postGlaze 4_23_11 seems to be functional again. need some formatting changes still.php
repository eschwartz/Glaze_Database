	...
	<!-- Header (Glaze Name)-->
        ...
        <div id="glazeTitle">Glaze name</div>
            <div id="headerBtns">
                ...
                <button id="input_newVar" class="ui-button ui-widget ui-state-default ui-button-text-only" role="button"><span class="ui-icon ui-icon-plusthick" style="float:left"></span> Add a new glaze variation</button>
                <div class="clear"></div>
