...
<div id='content-container' >
	...
	<div id='content-column'>
		...
		<div class='section' style="margin-top:2px;">
			...
			<button name="btn_calcPW" id="btn_calcPW" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text">Calculate PW</span></button>	<!--NEED onclick='calcPW()' in JS for this button -->
	
			<!-- Save Glaze-->
			<button name="saveForm"  class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text">Save Glaze</span></button>	<!-- NEED onclick="saveGlaze()" in javascript for button -->
