...
function Glaze(id) {
	...
	thisObj.removeIngr = function(ingrObj) {
		...
		for (var i in thisObj.recipe) {
			if(thisObj.recipe[i].IngredientID != ingrObj.IngredientID) {
				newRecipe.push(thisObj.recipe[i]);
			}
		}
		
		thisObj.recipe = newRecipe;
		/* BTW: cannnot use 'delete thisObj.recipe
